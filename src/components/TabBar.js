//setting komponen header sendiri 

import React, { useState, useEffect } from 'react'
// import * as Animated from 'react-native-animatable'                 //ini belum diinstal
import { View, Text, TouchableOpacity } from 'react-native'
import { Icon } from 'native-base'

const MyTabBar = ({ state, descriptors, navigation }) => {          //terima props dari navigator di app.js
